...
sudo wget https://repo.jellyfin.org/files/server/linux/latest-stable/amd64/jellyfin_10.11.0-amd64.tar.gz
sudo tar xvzf jellyfin_10.11.0-amd64.tar.gz -C /tmp/opt/jellyfin/

rm -rf jellyfin_10.11.0-amd64.tar.gz
