...
def run_update_strm_script(new_token):
    try:
        ...
        subprocess.run(['python', '/tmp/opt/jellyfin/STRM/m3u8/IOSMIRROR/Netflix/update_strm.py', '/tmp/opt/jellyfin/STRM/m3u8/IOSMIRROR/Netflix/Series',new_token], check=True)
